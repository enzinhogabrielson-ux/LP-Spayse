...
export const valuePropositions = [
  {
    title: 'Uma integração centralizada',
    description: 'Conecte toda sua operação financeira em uma única infraestrutura, eliminando fragmentação e ganhando visibilidade total.',
    icon: 'Zap',
  },
  {
    title: 'Cobertura local e internacional',
    description: 'Opere com profundidade nos principais mercados da América Latina e expanda com inteligência para novas geografias.',
    icon: 'Globe',
  },
  {
    title: 'Compliance e segurança operacional',
    description: 'Padrões rigorosos de conformidade e proteção em cada camada da operação, para que você cresça com tranquilidade.',
    icon: 'Shield',
  },
  {
    title: 'Escalabilidade para crescimento regional',
    description: 'Uma base tecnológica preparada para crescer com a sua operação, sem comprometer performance ou controle.',
    icon: 'TrendingUp',
  },
];
